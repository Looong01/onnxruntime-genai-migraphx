...
def _download_ort(use_cuda: bool, use_rocm: bool, use_migraphx: bool, use_dml: bool, destination_dir: PathLike):
    def _lib_path():
...
def download_dependencies(use_cuda: bool, use_rocm: bool, use_migraphx: bool, use_dml: bool, destination_dir: PathLike):
    dependencies_dir = destination_dir / "dependencies"
    if not dependencies_dir.exists():
        dependencies_dir.mkdir(parents=True)

    ort_lib_dir = _download_ort(use_cuda, use_rocm, use_migraphx, use_dml, dependencies_dir)
